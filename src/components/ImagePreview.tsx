...
import { ImageGenerationSettings, IMAGE_DIMENSIONS, STYLE_PREVIEWS } from '../types/image';
...
export function ImagePreview({ settings, onTextMove, onLogoMove, previewImage }: ImagePreviewProps) {
  ...
  React.useEffect(() => {
    const updateDimensions = () => {
      ...
      let { width, height, aspectRatio } = settings.customDimensions
        ...
        : IMAGE_DIMENSIONS[settings.size];
  ...
  }, [settings.size, settings.customDimensions]);
